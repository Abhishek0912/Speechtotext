...
class SpeechRecognizerSubject( application: Application) : AndroidViewModel(application), RecognitionListener {
    ...
    private val speechRecognizer: SpeechRecognizer = SpeechRecognizer.createSpeechRecognizer(application.applicationContext).apply {
        setRecognitionListener(this@SpeechRecognizerSubject)
    }
